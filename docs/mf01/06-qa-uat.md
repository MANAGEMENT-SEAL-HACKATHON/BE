...
| [05-test-data.md](05-test-data.md) | JSON mẫu, Luồng A/B |
| [04-quy-trinh-van-hanh.md#timeline--events](04-quy-trinh-van-hanh.md#timeline--events) | Timeline & Events |
...
| QA-07 | Legacy route (đã gỡ trong code) | Xem [02-functional-requirements.md](02-functional-requirements.md) Phụ lục Drift |
...
Xem [04-quy-trinh-van-hanh.md §0](04-quy-trinh-van-hanh.md#0-tiền-đề-khi-gọi-api) và seed/JSON tại [05-test-data.md](05-test-data.md).
...
> JSON đầy đủ từng bước: [05-test-data.md §3](05-test-data.md). Dưới đây là TC map + body tóm tắt.
...
Expected: **201**; lưu `invitationId` từ `data.invitation.id` (nếu có). Invitation judge: hiệu lực **3 ngày** (spec loại 3 — [mf02-invitations-spec.md](./mf02-invitations-spec.md)).
...
#### TC-GD1-E05 — Invitation resend còn hạn (chỉ loại 3 — `role=JUDGE`)
