...
| 4 | **Phase 3 — J1/J2/J3** | J1: `PresentationQueuePage` `hasLatePending` gate + `totalParticipatingCount`; J2: `LateSubmissionReviewPage` đọc `hackathonId`+`roundId` + breadcrumb; J3: `startAlreadyActiveRoundEarly` (historical — **START_NOW removed phase 2**) | ✅ Đạt |
