...
| LOTTERY-DATA-01 | PASS | listed=3 teams=0 hasNotSubmittedLabel=false | gd3-step-04-lottery-panel-BEFORE.png |
...
| RBL-CALIB-01-UI | PASS | banner=true coordBadge=true promptId=1 anon=true | rbl-calib-01-ui.png |
...
| VALID-05 | PASS | blocked HTTP 422 INVALID_ROUND_STATE_NOT_CLOSED | — |
