...
| FAIL-03 | SKIP | Chuyển quyền visible=true enabled=false (need different judge selected) | — |
...
| GD3-BTNS | PASS | status=true close=false | gd3-step-01-rounds.png |
| GD3-FORCE-ALERT | SKIP | forceAlert=false ratio=false | gd3-step-02-close-modal.png |
| LOTTERY-DATA-01 | FAIL | listed=null teams=0 hasNotSubmittedLabel=false | gd3-step-04-lottery-panel-BEFORE.png |
...
| THESIS-RBL-02 | FAIL | variance HTTP 200 anon=false | — |
