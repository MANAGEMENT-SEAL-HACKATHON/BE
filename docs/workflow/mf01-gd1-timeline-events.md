...
Hạn Chung kết < AWARDS.startsAt; AWARDS.startsAt > hạn CK (hai chiều khi CK đã có deadline)
...
| Chung kết | `submissionDeadline` &lt; `AWARDS.startsAt`; tạo AWARDS: `startsAt` &gt; hạn CK | `ROUND_FINAL_DEADLINE_AFTER_AWARDS`, `AWARDS_BEFORE_FINAL_DEADLINE` |
