...
public class ExportJobController {
    ...
    @Operation(summary = "FR-34/35 — Tải file export (stub)")
    public ResponseEntity<ApiResponse<String>> download(@PathVariable Integer id) {
        String url = exportJobService.downloadUrl(id);
