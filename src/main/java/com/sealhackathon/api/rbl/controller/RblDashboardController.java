...
public class RblDashboardController {
    ...
    @Operation(summary = "FR-30 — Phương sai chấm điểm theo judge/criterion")
    public ResponseEntity<ApiResponse<List<RblVarianceItemResponse>>> variance(@PathVariable Integer id) {
